		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "namespace_config.0.schema_auto_update_compatibility_strategy", "ForwardTransitive"),
					resource.TestCheckResourceAttr(resourceName, "namespace_config.0.schema_compatibility_strategy", "BackwardTransitive"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "backlog_quota.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "namespace_config.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "namespace_config.0.schema_auto_update_compatibility_strategy", "Full"),
					resource.TestCheckResourceAttr(resourceName, "namespace_config.0.schema_compatibility_strategy", "Full"),
					resource.TestCheckNoResourceAttr(resourceName, "enable_deduplication"),
					resource.TestCheckNoResourceAttr(resourceName, "permission_grant.#"),
				),
			},
